...
var _user$project$Types$Greeting = function (a) {
	return {ctor: 'Greeting', _0: a};
};
var _user$project$Types$Initial = {ctor: 'Initial'};
var _user$project$Types$StartGreeting = {ctor: 'StartGreeting'};
...
var _user$project$State$init = {ctor: '_Tuple2', _0: _user$project$Types$Initial, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$State$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'Back') {
			...
			return {
				ctor: '_Tuple2',
				_0: _user$project$Types$Greeting('Vida'),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});

var _user$project$View$congratulateView = function (name) {
	return {
		ctor: '::',
		_0: A2(
			_rundis$elm_bootstrap$Bootstrap_Grid$row,
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Grid_Row$attrs(
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('align-self-center w-100 h-100'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					_rundis$elm_bootstrap$Bootstrap_Grid$col,
					{
						...
						_1: {
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mx-auto text-center'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('align-middle w-100 h-100'),
								_1: {
									ctor: '::',
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('text-animate'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_0: _elm_lang$html$Html$text(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'Draga ',
														A2(_elm_lang$core$Basics_ops['++'], name, ' vse najboljše!'))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$src('music/hbd.mp3'),
											_1: {
												ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Back),
									_1: {
										ctor: '::',
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Nazaj'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$presentView = {
	ctor: '::',
	_0: A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$row,
		{
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Vse najboljše :)'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src('imgs/if_gifts_66104.png'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('align-middle'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$StartGreeting),
														_1: {ctor: '[]'}
													}
												}
											},
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('(Klikni na darilo)'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$View$view = function (model) {
	var page = function () {
		var _p0 = model;
		if (_p0.ctor === 'Initial') {
			return _user$project$View$presentView;
		} else {
			return _user$project$View$congratulateView(_p0._0);
		}
	}();
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('h-100 d-flex'),
				_1: {ctor: '[]'}
			}
		},
		page);
...
var _user$project$App$main = _elm_lang$html$Html$program(
	{init: _user$project$State$init, update: _user$project$State$update, view: _user$project$View$view, subscriptions: _user$project$State$subscriptions})();
